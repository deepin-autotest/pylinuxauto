...
from pylinuxauto.attr.dogtail import path
from pylinuxauto.attr.dogtail import predicate
from pylinuxauto.attr.dogtail import rawinput
from pylinuxauto.attr.dogtail.logging import debugLogger as logger
from pylinuxauto.attr.dogtail.utils import doDelay, Blinker, Lock
...
if config.checkForA11y:
    from pylinuxauto.attr.dogtail.utils import checkForA11y
    checkForA11y()
...
class Node(object):
    ...
    def dump(self, type='plain', fileName=None):
        from pylinuxauto.attr.dogtail import dump
